 ...
 *
 * @author Eric L SHU
 * @date 2022-10-01 7:45 PM
 * @since jdk-11.0.14
 */
public class P1694ReformatPhoneNumber
{
    public String reformatNumber_baoli(String number)
    {
        ...
        while (idx < (len / 3) - 1)
        {
            list.add(number.substring(3 * idx, 3 * (idx + 1)));
            idx++;
        }
        String left = number.substring(3 * idx);
        if (left.length() == 3)
        {
            list.add(left);
        }
        else if (left.length() == 4)
        {
            ...
            list.add(left.substring(2));
        }
        else
        {
            list.add(left.substring(0, 3));
            list.add(left.substring(3));
        }
        return String.join("-", list);
    }

    public String reformatNumber_official(String number)
    {
