...
public class CollectionTest
{
    ...
    public void test0445()
    {
        ...
        ListNode l3 = new ListNode(9, new ListNode(9, new ListNode(9)));
        ListNode l4 = new ListNode(9, new ListNode(9, new ListNode(9, new ListNode(9, new ListNode(9)))));
        System.out.println(p0445.addTwoNumbers_1(l1, l2));
        System.out.println(p0445.addTwoNumbers_2(l3, l4));
    }
    ...
    public void test1917()
    {
        ...
        System.out.println(authenticationManager1.countUnexpiredTokens(6));      // 时刻 6 时，只有 tokenId 为 "aaa" 的验证码未过期，所以返回 1 。
        ...
        System.out.println(authenticationManager1.countUnexpiredTokens(15));     // tokenId 为 "bbb" 的验证码在时刻 15 过期，tokenId 为 "aaa" 的验证码在时刻 7 过期，所有验证码均已过期，所以返回 0 。
        ...
        System.out.println(authenticationManager2.countUnexpiredTokens(6));      // 时刻 6 时，只有 tokenId 为 "aaa" 的验证码未过期，所以返回 1 。
